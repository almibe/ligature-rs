...
interface Graph {
     ...
     * given unique names in the current graph.  Literals are not merged.
     */
    fun addGraph(graph: Graph)
    /**
     * Add a given statement to this graph.  The subject will be added if it doesn't already exist, a new predicate
    ...
    /**
     * Remove a given statement from this graph.  The subject is not removed, the predicate always is removed,
     * and the object is removed only if it is a Literal.
     */
    fun removeStatement(subject: Subject, predicate: Predicate, `object`: Object)
    /**
     * Remove a subject from this graph.  All predicates related to this object are removed and all objects of those
